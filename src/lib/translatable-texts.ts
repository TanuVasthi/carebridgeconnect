...
export const ALL_TEXTS: string[] = [
  ...
  "Linda Garcia",
  "David Rodriguez",
  "Compassionate and experienced caregiver with 8 years of dedication to providing high-quality in-home care. Specialized in dementia and Alzheimer's care.",
  "A friendly and reliable caregiver with 5 years of experience. I focus on creating a positive and supportive environment for my clients.",
  "With over a decade of experience, I provide professional and empathetic care, specializing in post-operative recovery and nutritional support.",
  "Dedicated caregiver focused on helping clients regain independence. Experienced in supporting physical therapy routines and wound care.",
  "CPR Certified",
  "Dementia Care",
  "First Aid",
  ...
  "Please add emergency contacts in the settings page first.",
  "Go to Settings",
  "SOS Alert Sent!",
  "Your location and emergency information have been sent to your contacts.",
  "Could not get location. Emergency info sent to contacts without location data.",
  "Geolocation not supported. Emergency info sent to contacts without location data.",
  "Emergency Contacts",
